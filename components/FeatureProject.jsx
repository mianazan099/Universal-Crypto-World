...
function FeatureProject() {
  return (
    <section className="mb-24">
      <div className="mx-auto mb-16 hidden h-[324px] max-w-[920px] gap-10 rounded-lg bg-dark-two px-10 py-14 text-start lg:flex">
        <div className="relative -top-32 h-[340px] w-[300px] rounded-lg bg-[hsla(0,0%,85%,1)]"></div>
        <div>
          <div className="mb-8">
            <h2 className="text-h2 mb-8">Feature Project</h2>
          ...
          <div className="flex flex-row-reverse items-center justify-end gap-5">
            <button className="rounded-lg bg-gradientTwo px-10 py-3 text-md font-bold">
              Chart Link
            </button>
            <div className="flex gap-5">
              {/* mx-auto flex w-fit gap-5 */}
              <Image src="/www-icon.svg" alt="" height="24" width="24" />
              <Image src="/telegram-logo.svg" alt="" height="24" width="24" />
              <Image src="/twitter-logo.svg" alt="" height="24" width="24" />
            </div>
          </div>
        </div>
      </div>
...
function Card({ title, starting, highest }) {
  return (
    <div className="rounded-lg bg-dark-two p-8 pb-5">
      ...
      <button className="mb-5 rounded-lg bg-gradientTwo px-9 py-3 text-md font-bold">
        Chart Link
      </button>
