...
function Faq() {
  return (
    <section className="mb-24 text-center">
      <h2 className="mb-8 text-xl font-bold sm:text-3xl sm:leading-[45px]">
      ...
      <div className="mx-auto max-w-3xl space-y-3 sm:space-y-5">
        ...
        <Item title="Open me. Please!🥺🥺🥺">
          Ha Ha Ha Ha Ha Ha Ha! I am now free. after a thousand years and now i
          will destroy this world and kill every living thing on this planet.
          and i will start with you. DIE! 😈😈😈
        </Item>
      </div>
    </section>
  );
...
const Item = ({ title, children }) => {
  ...
  return (
    <div className="rounded-lg bg-dark-two ">
      <button
        type="button"
      ...
      {isOpen && (
        <div className="rounded-b-lg bg-[hsla(267,14%,25%,1)] px-8 py-5 text-start">
