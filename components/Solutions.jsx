function Solutions() {
  return (
    <section className="mb-24">
      <h2 className="text-h2 mb-10 text-center">Our Solutions</h2>
...
function Card({ num, name, disc }) {
  return (
    <div className="rounded-lg bg-dark-two p-8 text-start">
      <span className="gradient-text mb-3 block bg-gradientTwo text-xs font-bold sm:text-sm">
        {num}
      </span>
